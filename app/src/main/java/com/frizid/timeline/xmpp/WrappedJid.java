...
public class WrappedJid implements com.frizid.timeline.xmpp.Jid {
    ...
    @Override
    public com.frizid.timeline.xmpp.Jid asBareJid() {
        return new WrappedJid(inner.asBareJid());
    }

    @Override
    public com.frizid.timeline.xmpp.Jid withResource(CharSequence resource) {
    ...
    @Override
    public com.frizid.timeline.xmpp.Jid getDomain() {
    ...
    @Override
    public int compareTo(com.frizid.timeline.xmpp.Jid jid) {
