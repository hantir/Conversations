...
public class CreatePostActivity extends AppCompatActivity implements PrivacyPick.SingleChoiceListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Picasso.get().load(ParseUser.getCurrentUser().getParseFile("photo").getUrl()).into(mDp);
        } catch (NullPointerException e1) {
        }

        //Name
        TextView mName = findViewById(R.id.name);
        mName.setText(Objects.requireNonNull(ParseUser.getCurrentUser().get("name")).toString());
            ...
            if (type.equals("bg")) {
                ...
                if (Objects.requireNonNull(bg_text.getText()).toString().isEmpty()) {
                    ...
                    if (number.equals("upload")) {
                        ...
                        Post posti = new Post();
                        posti.setUserObj(ParseUser.getCurrentUser());
                        posti.setText(postText.getText().toString());
                        posti.setType(type);
                        posti.setUrl(number);
    ...
    private void compressImage(Uri image_uri) {
        ...
        //Upload
        Bitmap image_bit = App.uriToBitmap(this, image_uri);
        String mime=".jpg";
        byte[] scaledData = App.getParseFileBytes(this, image_bit, mime);
            ...
            try {
                if (resultCode == RESULT_OK) {
                    if (cameraUtil != null && cameraUtil.mCurrentPhotoPath != null) {
                        ...
                        new FileURI(cameraUtil.mCurrentPhotoPath, cameraUtil.fileName, CreatePostActivity.this).execute();
...
//            Picasso.get().load(image_uri).into(imageView);
            ...
            //TODO : to add photo editor
            try {
                Intent intent = new Intent(CreatePostActivity.this, EditImageActivity.class);
        ...
        if (resultCode == RESULT_OK && requestCode == REEl_PICK_CODE && data != null) {
            ...
            if (timeInMilli > 60000) {
                ...
                Intent intent = new Intent(CreatePostActivity.this, PostReelActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.camera:
                ...
                /*try {
                    Intent intent = new Intent(CreatePostActivity.this, MediaSelectActivity.class);
            ...
            case R.id.gif:
                ...
                /*Intent spintent = new Intent(CreatePostActivity.this, StickersPost.class);
    ...
    private void cameraIntent() {
            if (cameraUtil == null) {
                cameraUtil = new CameraUtil(CreatePostActivity.this);
                cameraUtil.mCurrentPhotoPath = null;
                cameraUtil.openCamera(CreatePostActivity.this, CAMERA_REQUEST_CODE);
            }
    }
    ...
    public void showSnackBar(ConstraintLayout constraintLayout, String msg) {
