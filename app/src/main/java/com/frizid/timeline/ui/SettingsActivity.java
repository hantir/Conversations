...
import com.frizid.timeline.services.ExportBackupService;
...
public class SettingsActivity extends XmppActivity implements
	...
	public void onStart() {
		...
		boolean removeLocation = new Intent("com.frizid.timeline.location.request").resolveActivity(getPackageManager()) == null;
